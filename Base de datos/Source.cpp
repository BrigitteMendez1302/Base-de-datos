...
int main() {
	...
	basededatos->gettablainpos(0)->agregarcolumna(1,"Bri");
	basededatos->gettablainpos(0)->agregarcolumna(2,"Bri1");
	...
	cout << "Apellido : \n" << endl;cin >> paracolumna;
	basededatos->gettablainpos(0)->getcolumnainpos(1)->agregardato(paracolumna);
	//CColumna* nuevacolumna = basededatos->gettablainpos(0)->getcolumnainpos(0);
	//basededatos->gettablainpos(0)->traspasarcolumna(nuevacolumna);
	...
	basededatos->gettablainpos(0)->indexar(0);
	basededatos->gettablainpos(0)->mostrarregistros();
	auto lambda0 = [=](vector<string>* a) {
		for (short i = 0; i < a->size(); i++) cout << a->at(i) << " ";
		cout << endl;
	};
	//CTabla* auxiliar = basededatos->gettablainpos(0);
	basededatos->gettablainpos(0)->getabbF()->enorden(lambda0);cout << endl << "tabla aux\n";
	//auxiliar->getabbF()->enorden(lambda0);
	//cout << "\columna aux\n"<< nuevacolumna->getmidatoinpos(0)<<endl;
